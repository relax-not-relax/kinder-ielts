...
import tutorBanner2 from "../../assets/tutor_2.png";
...
const TUTORS_DATA = [
  {
    ...
    avatar: tutorBanner2,
    achievements: [
      "IELTS 8.5 (8.5 Reading, 8.0 Listening, 8.5 Writing, 8.0 Speaking)",
      "Chứng chỉ Giảng dạy tiếng Anh TESOL",
      "IDP Teacher Training Writing & Speaking",
      "Top National Finalists - P&G CEO Challenge 2022",
    ],
    historyTrainee: [
      "Thạc sĩ Marketing - ĐH Macquarie, Úc",
      "Cử nhân Marketing - ĐH Western Sydney, Việt Nam",
    ],
    experience: [
      "Academic Assistant - The IELTS Workshop (2022 - 2023)",
      "Teaching Assistant - The IELTS Workshop (2022)",
      "Teaching Assistant - The IELTS Workshop (2020 - 2023)",
      "Freelance IELTS Tutor (2020 - Now)",
    ],
  },
  {
    id: 1,
    name: "Gia sư Minh Khuê",
    score: "8.0",
    avatar: tutorBanner,
    achievements: [
  ...
  const prevTutor = () => {
    ...
    setTimeout(() => {
      setCurrentTutorIndex(
        (prev) => (prev - 1 + TUTORS_DATA.length) % TUTORS_DATA.length
      );
      setIsTransitioning(false);
    }, 300);
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <p className="text-lg text-gray-700 mb-1 text-left">
          Gia sư Kinder IELTS được đào tạo sư phạm mỗi quý, cập nhật xu hướng
          thi và là đối tác của IDP IELTS Việt Nam.
        </p>
        <p className="text-lg text-gray-700 mb-8 text-left">
          Chúng tôi cam kết chất lượng giảng dạy với các buổi huấn luyện chuyên
          sâu từ chuyên gia.
        </p>
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/3 w-full relative ">
              ...
              {/* Tutor Name at top-left */}
              <div
                className={`absolute top-4 left-4 text-white font-bold text-lg px-3 py-1 ${
                  isTransitioning ? "opacity-0" : "opacity-100"
                } transition-opacity duration-300`}
              >
                {currentTutor.name}
              ...
              <div className="absolute top-4 right-4 flex gap-2">
                <button
                  ...
                  className="bg-white hover:bg-white text-custom-green p-2 rounded-md shadow-md transition-all duration-200 hover:shadow-lg"
                >
                  <svg
            ...
            <div className={`lg:w-2/3 w-full p-6 lg:p-8 `}>
              {currentTutor.historyTrainee?.length > 0 && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-custom-green mb-3">
                    Lịch sử đào tạo:
                  </h4>
                  <ul className="space-y-2">
                    {currentTutor.historyTrainee.map((achievement, index) => (
                      <li
                        key={index}
              ...
              {currentTutor.achievements?.length > 0 && (
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-custom-green mb-3">
              ...
              {currentTutor.experience?.length > 0 && (
                <div>
                  <h4 className="text-lg font-semibold text-custom-green mb-3">
